...
Format: `<type of event> <description> /dd-MM-yyyy HHmm HHmm /<period(in days)>`
...
image::contactView.png[width = "800"] //need update
...
image::contactDelete.png[width = "800"] //need update
...
====
image::recurringEventSequenceDiagram.png[width = "800"] //need update
====
